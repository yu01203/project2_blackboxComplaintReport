          ...
          <template slot="header">
            <div class="row">
              <div class="col-sm-6" :class="isRTL ? 'text-right' : 'text-left'">
                <template v-if="!isRTL">
                  <h5 class="card-category">20200717</h5>
                </template>
                <template v-else>
                  <h5 class="card-category">مجموع الشحنات</h5>
                </template>
                <template v-if="!isRTL">
                  <h2 class="card-title">국내 교통 법규 위반 건수</h2>
                </template>
                <template v-else>
      ...
      <div class="col-lg-4" :class="{'text-right': isRTL}">
        <card type="chart" cardCol>
          <template slot="header">
            ...
            <h5 class="card-category">민원 접수 건수</h5>
            <h3 class="card-title">
              <i class="tim-icons icon-bell-55 text-primary"></i> 163,215
            </h3>
          </template>
          <line-chart
            class="chart-area"
      ...
      <div class="col-lg-4">
        <card type="chart" cardCol>
          <template slot="header">
            ...
            <h5 class="card-category">분노의 민원을 통한 민원 접수 건수</h5>
            <h3 class="card-title">
              <i class="tim-icons icon-delivery-fast text-info"></i> 3,500건
            </h3>
          </template>
          <bar-chart
            class="chart-area"
      ...
      <div class="col-lg-4">
        <card type="chart" cardCol>
          <template slot="header">
            ...
            <h5 class="card-category">민원 처벌 건수</h5>
            <h3 class="card-title">
              <i class="tim-icons icon-send text-success"></i> 1,210건
            </h3>
          </template>
          <line-chart
            class="chart-area"
