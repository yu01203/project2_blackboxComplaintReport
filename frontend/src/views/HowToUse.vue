<template>
  <div class="container-sm">
    ...
    <div class="divdiv shadow-lg p-3 mb-5 bg-white rounded">
      ...
      <p class="d-none d-md-block">
        영상을
        <span style="color: white; background-color: #0f4c81">다운로드</span> 받은 후 하단의
        <span style="color: white; background-color: #0f4c81">스마트 국민제보로 신고하러 가기</span> 버튼을 누릅니다.
      </p>
      <p class="d-md-none mobile_p">
        영상을
        <span style="color: white; background-color: #0f4c81">다운로드</span> 받은 후 하단의
    ...
    <div class="divdiv shadow-lg p-3 mb-5 bg-white rounded">
      ...
      <p class="d-none d-md-block">
        스마트 국민제보 사이트에서 회원가입 후
        <span class="bg-secondary text-light">로그인</span>을 합니다.
      </p>
      <p class="d-md-none mobile_p">
        스마트 국민제보 사이트에서 회원가입 후
        <span class="bg-secondary text-light">로그인</span>을 합니다.
      ...
      <p class="d-none d-md-block">
        메인화면에 보이는
        <span class="bg-secondary text-light">교통위반</span> 버튼을 누릅니다.
      </p>
      <p class="d-md-none mobile_p">
        메인화면에 보이는
        <span class="bg-secondary text-light">교통위반</span> 버튼을 누릅니다.
      ...
      <p class="d-none d-md-block">
        ...
        <span class="bg-primary" style="color:white;">신고하기</span> 버튼을 누릅니다.
      </p>
      <p class="d-md-none mobile_p">
        분노의민원 사이트 제보목록에
        <span style="color:white; background-color: #B6CADA">저장된 카드</span>
      ...
      <p class="d-none d-md-block">
        ...
        <span style="color: dark; background-color: #ebdfbe">신고 미접수</span> 상태를
        <span style="color: white; background-color: #B6CADA">접수 완료</span> 상태로 바꿔줍니다.
      </p>
      <p class="d-md-none mobile_p">
        신고가
        <span style="color: white; background-color: #0f4c81">완료</span>됐다면 분노의민원 사이트로 돌아와 사진처럼
